...
import { ArrowLeft, BookOpen, Flag, Flame, History, Layers, Plus, Target } from "lucide-react";
      ...
      <header className="border-b">
        <div className="mx-auto max-w-5xl px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button asChild variant="ghost" size="sm">
              <Link to="/questions/stats">
                <Target className="mr-1.5 h-4 w-4" />
                {t("q_stats")}
              </Link>
            </Button>
            <Button asChild variant="ghost" size="sm">
              <Link to="/questions/flagged">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {stats?.totalAnswered ?? 0} {t("questions_seen")}
              </p>
            </CardContent>
          </Card>
        </div>
                ...
                <div key={y}>
                  ...
                  <div className="grid gap-2 sm:grid-cols-2">
                    {byYear[Number(y)].map((m) => (
                      <Link
                        key={m.id}
                        to="/modules/$moduleId/entrainement"
